...
mod tests {
    ...
    fn test_coordinate_apply_direction() {
        ...
        assert_eq!(coord.apply_direction(Direction::Up), Coordinate { x: 5, y: 6 });
        assert_eq!(coord.apply_direction(Direction::Down), Coordinate { x: 5, y: 4 });
        assert_eq!(coord.apply_direction(Direction::Left), Coordinate { x: 4, y: 5 });
        assert_eq!(coord.apply_direction(Direction::Right), Coordinate { x: 6, y: 5 });
    }
    ...
    fn test_coordinate_apply_direction_boundaries() {
        ...
        assert_eq!(coord.apply_direction(Direction::Down), Coordinate { x: 0, y: 0 });
        assert_eq!(coord.apply_direction(Direction::Left), Coordinate { x: 0, y: 0 });
    }
