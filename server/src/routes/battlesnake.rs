...
///
/// web-app[impl battlesnakes.list.route]
/// web-app[impl battlesnakes.list.auth_required]
/// web-app[impl battlesnakes.list.display]
/// web-app[impl battlesnakes.list.empty_state]
/// web-app[impl battlesnakes.list.flash_messages]
...
///
/// web-app[impl battlesnakes.create.form_route]
/// web-app[impl battlesnakes.create.auth_required]
/// web-app[impl battlesnakes.create.form_fields]
...
///
/// web-app[impl battlesnakes.create.submission]
/// web-app[impl battlesnakes.create.success_redirect]
/// web-app[impl battlesnakes.create.success_flash]
...
///
/// web-app[impl battlesnakes.edit.form_route]
/// web-app[impl battlesnakes.edit.auth_required]
/// web-app[impl battlesnakes.edit.ownership_check]
/// web-app[impl battlesnakes.edit.form_fields]
...
///
/// web-app[impl battlesnakes.edit.submission]
/// web-app[impl battlesnakes.edit.success_redirect]
/// web-app[impl battlesnakes.edit.success_flash]
/// web-app[impl battlesnakes.edit.ownership_check]
...
///
/// web-app[impl battlesnakes.delete.route]
/// web-app[impl battlesnakes.delete.auth_required]
/// web-app[impl battlesnakes.delete.ownership_check]
/// web-app[impl battlesnakes.delete.success_redirect]
/// web-app[impl battlesnakes.delete.success_flash]
