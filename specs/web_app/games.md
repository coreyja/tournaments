...
Each game MUST have a game type: Standard, Royale, Constrictor, or Snail Mode.
...
The flow page MUST display a game type selector with options: Standard, Royale, Constrictor, Snail Mode.
...
r[game.view.auth_required]
The game details MUST require authentication.
...
r[game.view.display_created]
The details page MUST display the creation date.
...
r[game.view.results_url]
For each battlesnake, the results table MUST show the URL as a link.

r[game.view.placement_badges]
Placements MUST be displayed with appropriate badges (1st=gold, 2nd=silver, 3rd=bronze).
