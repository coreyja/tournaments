 ...
 * Create Game
 *
 * web-app[verify game.create.new_route]
 * web-app[verify game.create.new_auth_required]
 * web-app[verify game.create.flow_redirect]
 * web-app[verify game.flow.route]
 * web-app[verify game.flow.board_size_selector]
 * web-app[verify game.flow.game_type_selector]
 * web-app[verify game.flow.user_snakes]
 * web-app[verify game.flow.no_snakes_warning]
 * web-app[verify game.flow.selection_counter]
 * web-app[verify game.flow.no_selection_warning]
 * web-app[verify game.flow.create_button_hidden]
 * web-app[verify game.flow.add_snake.route]
 * web-app[verify game.flow.remove_snake.route]
 * web-app[verify game.flow.reset.route]
 * web-app[verify game.flow.reset.clears_all]
 * web-app[verify game.flow.search.route]
 * web-app[verify game.flow.search.public_only]
 * web-app[verify game.flow.search.private_hidden]
 * web-app[verify game.create.success_redirect]
